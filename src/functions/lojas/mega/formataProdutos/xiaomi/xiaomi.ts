...
export const formataXiaomiMega = (produtoLoja: IProdutoLoja): IProdutoLoja | null => {
    ...
    const capacidade =
        /\+1024/i.test(produtoLoja.nome) ? 1024 :
    ...
    if (capacidade) novoNome = novoNome.replace(new RegExp(/\b512GB\b|1024|\b512G\b|\b512\b|\b256GB\b|\b256G\b|\b256\b|\b128GB\b|\b128G\b|\b128\b|\b64GB\b|\b64G\b|\b64\b|\b32GB\b|\b32G\b|\b32\b|\b16GB\b|\b16G\b|\b16\b/gi, 'i'), '');
    if (capacidade) novoNome = novoNome.replace(new RegExp(/\+1024\b|\+512\b/g, 'i'), "");
