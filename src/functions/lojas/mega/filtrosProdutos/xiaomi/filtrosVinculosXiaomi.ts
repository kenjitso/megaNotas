...
export function filtrosVinculosXiaomiMega(produtoParaguay: IProdutoLoja, produtoML: any) {
    ...
    if (produtoML.modelo) {
        ...
        if (produtoParaguay.nome.toUpperCase().trim() === "A1 PLUS" && produtoML.nome.toUpperCase().trim().includes("A1+")) similarity++;
