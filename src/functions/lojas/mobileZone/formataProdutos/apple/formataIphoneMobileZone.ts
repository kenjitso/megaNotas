...
export const formataIphoneMobileZone = (produtoLoja: IProdutoLoja): IProdutoLoja | null => {
    const marca =
                                                        ...
                                                        /CINZA/i.test(produtoLoja.nome) ? "CINZA" :
                                                            /SILVER/i.test(produtoLoja.nome) ? "PRATA" :
                                                                /ONYX BLACK/i.test(produtoLoja.nome) ? "PRETO" :
                                                                    /SPACE GRAY/i.test(produtoLoja.nome) ? "PRETO" :
                                                                        /SPACE GREY/i.test(produtoLoja.nome) ? "PRETO" :
                                                                                                                                                                                    ...
                                                                                                                                                                                    /BLUE/i.test(produtoLoja.nome) ? "AZUL" :
                                                                                                                                                                                        /YELLOW/i.test(produtoLoja.nome) ? "AMARELO" :
                                                                                                                                                                                            /DOURADO/i.test(produtoLoja.nome) ? "DOURADO" :
                                                                                                                                                                                                /RED/i.test(produtoLoja.nome) ? "VERMELHO" :
    ...
    if (cor) novoNome = novoNome.replace(/VERDE|AZUL|CINZA|PRETO|LITE GREEN|BRANCO|ONYX BLACK|BLACK|GLACIER BLUE|MINT GREEN|ICE BLUE|TWILIGHT BLUE|STAR BLUE|COSMIC PURPLE|ONYX GRAY|SPACE GRAY|SPACE GREY|BRONZE|LIGHT BLUE|LAVANDER PURPLE|GRAPHITE GRAY|OCEAN BLUE|LAVENDER PURPLE|PRATA|PEPPY PURPLE|AMARELO|FOREST GREEN|PINK|ROSA|BLUE|GOLD|VERMELHO|GRAPHITE|YELLOW|MIDNIGHT|DOURADO|DEEP PURPLE|STARLIGHT|PURPLE|GREEN|SILVER|SPACE|RED/gi, '');
    ...
    novoNome = novoNome.replace(/CELULAR|DUAL SIM|CEL|OLED|LCD|WHITE JP| LZ | LL | BE | VC |CPO(?!.*CPO)|SLIM BOX(?!.*SLIM BOX)|\(ANATEL\)(?!.*\(ANATEL\))/gi, '').replace(/\s+/g, ' ').trimStart();
    ...
    if (novoNome.trim().toUpperCase() === "IPHONE XR A1984") produtoLoja.ram = 3;

    if (novoNome.trim().toUpperCase() === "IPHONE XS A1920") produtoLoja.ram = 4;

    if (novoNome.trim().toUpperCase() === "IPHONE SE 2020 A2275") produtoLoja.ram = 3;
    if (novoNome.trim().toUpperCase() === "IPHONE SE 2022 A2783") produtoLoja.ram = 4;


    if (novoNome.trim().toUpperCase() === "IPHONE 8 PLUS A1864") produtoLoja.ram = 3;
    ...
    if (novoNome.trim().toUpperCase() === "IPHONE 11 PRO A2160") produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === "IPHONE 11 PRO A2215") produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === "IPHONE 11 PRO MAX A2161") produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === "IPHONE 11 PRO MAX A2218") produtoLoja.ram = 4;
    ...
    if (novoNome.trim().toUpperCase() === "IPHONE 13 A2633") produtoLoja.ram = 4;
    ...
    if (novoNome.trim().toUpperCase() === "IPHONE 14 PLUS A2886 HN") produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === "IPHONE 14 PLUS A2886") produtoLoja.ram = 6;
    ...
    if (novoNome.trim().toUpperCase() === ("IPHONE 13 MLPH3LZ A2633")) produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === ("IPHONE 13 MLQ63LZ A2633")) produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === ("IPHONE 13 MLQ73LZ A2633")) produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === ("IPHONE 13 MLQ83LZ A2633")) produtoLoja.ram = 4;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PLUS MQ503BE A2886")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PLUS MR6D3BE A2886")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MAX D. MQ9X3BE A2894")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MAX MQ9P3BE A2894")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MAX MQ9T3BE A2894")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MAX MQ9W3BE A2894")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MQ0G3BE A2890")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MQ183BE A2890")) produtoLoja.ram = 6;
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PRO MQ1F3BE A2890")) produtoLoja.ram = 6;
    ...
    if (novoNome.trim().toUpperCase() === ("IPHONE 13 A2633")) produtoLoja.rede = 5;
    ...
    if (novoNome.trim().toUpperCase() === ("IPHONE 14 PLUS A2886")) produtoLoja.rede = 5;
