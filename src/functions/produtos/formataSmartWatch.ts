...
export const formataSmartWatch = (produtoLoja: IProdutoLoja): IProdutoLoja | null => {
    ...
    if (cor) novoNome = novoNome.replace(/LIGHTNING GRAY|LIGHTNINGGRAY|ONYX PEBBLE GREY|MOONLIGHT BRANCO|MOONLIGHT GRAY|FLAMINGO PINK|SPACE BLACK|EMBER BLACK|PETAL PINK|THUNDER BLACK|INFINITE BLACK|MOSS GREEN|MOON WHITE|OBSIDIAN BLACK|SPACE GRAY|MISTY WHITE|MINT BLUE|DESERT KHAKI|ASTRO BLACK|WILD GREEN|E SQUARE M.GREY|MIDNIGHT|OCEAN|GOLD|BLACK|PRETO|ROSA|AZUL|PINK|IVORY|YVORY|BROWN|CREAM|WHITE|MARFIM|BLUE/gi, '');
    ...
    if (pulseiraMedida) novoNome = novoNome.replace(/47MM|46MM|44MM|42MM|41MM|40MM|39MM|2MM/gi, '');
    if (marca) novoNome = novoNome.replace(/XIAOMI|APPLE|SAMSUNG/gi, '');
    if (tipoPulseira) novoNome = novoNome.replace(/SPORT/gi, '');
    novoNome = novoNome.replace(/\(A2174\)|BHR5439GL -|M2116W BHR5381GL|M2141B1 BHR5970GL|M2116W BHR5467GL|M2116W BHR5380GL|M2141B1 BHR6076GL|BHR6854GL|M2131W1|BHR6851GL|BHR5724GL|BHR5501GL|A2770|M2109W1|A2035|A1971|A1952|A2171|A1952|A2040|A1969|A2018|A2021|A2168|A2176|A2170/gi, '');
