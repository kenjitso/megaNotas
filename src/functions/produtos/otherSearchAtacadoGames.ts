...
export async function otherSearchAtacadoGames(produto: IProdutoLoja) {
    ...
    //IPHONE
    if (produto.nome.trim().toUpperCase() === "IPHONE 7" && produto.cor.trim().toUpperCase() === "ROSA") catalogo = await CatalogoController.searchCatalogoML("iPhone 7 128 GB ouro rosa");
    ...
    if (produto.nome.trim().toUpperCase() === "IPHONE 13 A2633HN") catalogo = await CatalogoController.searchCatalogoML("Apple iPhone 13 ("+produto.capacidade+") - "+produto.cor);
    ...
    if (produto.nome.trim().toUpperCase() === "NOTE 11 PRO+") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 11 Pro+ 5G (MediaTek) Dual SIM " + produto.capacidade + " GB " + produto.cor + " " + produto.ram + " GB RAM");
    if (produto.nome.trim().toUpperCase() === "NOTE 11 PRO+" && produto.cor.toUpperCase() === "VERDE") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 11 Pro+ " + produto.capacidade + " GB " + produto.cor + " " + produto.ram + " GB RAM");
    if (produto.nome.trim().toUpperCase() === "NOTE 11 PRO+" && produto.cor.toUpperCase() === "VERDE" && produto.capacidade === 256) catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 11 Pro+ 5G (MediaTek) Dual SIM " + produto.capacidade + " GB " + produto.cor + " " + produto.ram + " GB RAM");
    ...
    if (produto.nome.trim().toUpperCase() === "NOTE 12") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 12 " + produto.capacidade + " GB" + produto.cor + " " + produto.ram + " GB");
    if (produto.nome.trim().toUpperCase() === "NOTE 12" && produto.cor.toLocaleUpperCase() === "CINZA") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 12 4G Dual SIM "+produto.capacidade+" GB cinza-escuro "+produto.ram+" GB RAM");
    if (produto.nome.trim().toUpperCase() === "NOTE 12" && produto.cor.toLocaleUpperCase() === "VERDE") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi Note 12 Dual SIM "+produto.capacidade+" GB mint-green "+produto.ram+" GB RAM");
    ...
    if (produto.nome.trim().toUpperCase() === "REDMI 10A") catalogo = await CatalogoController.searchCatalogoML("Xiaomi Redmi 10A Dual SIM " + produto.ram + " GB " + produto.cor + " " + produto.capacidade + " GB RAM");
    ...
    if (produto.nome.trim().toUpperCase() === "GALAXY A04E A042M") catalogo = await CatalogoController.searchCatalogoML("Samsung Galaxy A04e" + produto.cor +" "+ produto.capacidade +" GB "+produto.ram+" GB");
    if (produto.nome.trim().toUpperCase() === "GALAXY A04S A047M") catalogo = await CatalogoController.searchCatalogoML("Samsung Galaxy A04s Dual SIM" + produto.cor +" "+ produto.capacidade +" GB "+produto.ram+" GB");
    if (produto.nome.trim().toUpperCase() === "GALAXY A14 A146M") catalogo = await CatalogoController.searchCatalogoML("Samsung GALAXY A14" + produto.cor +" "+ produto.capacidade +" GB "+produto.ram+" GB");
