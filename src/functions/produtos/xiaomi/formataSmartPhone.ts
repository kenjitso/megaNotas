...
export const formataSmartPhone = (produtoLoja: IProdutoLoja): IProdutoLoja | null => {
...
if(produtoLoja.nome.includes("A2783 RED")) produtoLoja.nome= produtoLoja.nome.replace("A2783 RED","VERMELHO");
    ...
    novoNome = novoNome.replace(/200MP|108MPX|108MP\+|64MP\+|64MP \+|50MP\+|54\/32MPX|13MP \+|13MP\+|8MP \+|8MP\+|8 MP\+|5MP \+|0.08MP E|0.08 MP|0.8MP E|0.3MP|HDR10\+|\+2MP E|\+ 16MP|\+16MP|\+8MP|\+2MP|50MP|48MP\+|48MP|16MP|E 13MP|13MP|E 8MP|8MP|E 5MP|5MP|E 32MP|E 20MP|E 16MP|E 2MP|2MP|\+ E|13\+8\+2|4K/g, '');
    novoNome = novoNome.replace(/CELULAR|GOLBAL|S ACS|CORE|\(CX FEIA\)|\(LACRE PEQUENO\)|A \(CPO\)|\(CPO\)|LTE|SEM LACRE|OLED|LCD|C ROTA|S LACRE|\(CARREGADOR 3 PINOS\)|CEL|DUAL SIM|TELA|CÂMERA QUÁDRUPLA|CÂMERAS DE|CÂMERAS|TRIPLA|CÂMERA|\+ ADAPTADOR|\+ADAPTADOR|\+ADATAP|ADAPTADOR|DESLACRADO S TIGO PERSONA|ATLA|\/|\(VITRINA\)|\(VITRINA\)|\*\*(?!.*\*\*)|C FEA(?!.*C FEA)|\-(?!.*\-)|DP(?!.*DP)|DG(?!.*DG)|\(NFC\)(?!.*\(NFC\))|NFC(?!.*NFC)|L P-(?!.*L P-)|US L P(?!.*US L P)|L P(?!.*L P)|US(?!.*US)|\.(?!.*\.)|\S CAPA(?!.*\S CAPA)|GLO(?!.*GLO)|(?!.*\S CAPA)|\s\+(?!.*\s\+)/gi, '').replace(/\s+/g, ' ').trim();
    novoNome = novoNome.replace(/\s643|\s653"|\s628''|\s667|SLIM BOX|JP SLIM BOX|LACP|C DETALLE|\(CARREGADOR PADRAO ARG\)|\(NANOSIMESIM\)|OPEN BOX 30 DIAS GARANTIA|\(30 DIAS GARANTIA\)|OPEN BOX 30 DIAS GAR|OPEN BOX|GT667"|\(ANATEL\)|\(C.F\)|\(CF\)|S CX S ACS| S L|S CX|CAM13\+2| ALED| CPO|\(SIM\)| LT(?!.* LT)/g, '');
    novoNome = novoNome.replace(/\s65''| LL| LZ/g, '');
    novoNome = novoNome.replace(/MLPH3LZ A2633|MLQ63LZ A2633|MLQ73LZ A2633|A2633HN|A2890BE|A2894BE|FGJ63B|FGJ93B|MLPG3LZ|MLQA3LZ|A2221|FJNP3B|FGJG3B|A2882HN|MQAJ3BE|MPUR3BE|A2894|MQC23BE|A2890|MQ2V3BE|MPWA3BE|MPV03BE|A2882|FGJH3ZD|FJNM3B|FGJG3QL|FGJF3B|FGJA3B|A A2403|FGJC3B|A2403|FGJC3ZD|A2215|A2160|VC A1984|A1984|A1920|A2161|A2783|A2650LL|A2218|BE A2886|A1864|A2275|A2896CH|A2651LL|A2633|MQ9X3BE A2894|LZ A2221|MQ503BE A2886|MR6D3BE A2886|MHDJ3LZ A2221|MQ523BE A2886|MQ083BE A2890|MQ9U3BE A2894|MQ023BE A2890|MPVN3BE A2882|MNGK3LZ A2633|MLPK3LZ A2633|MLPF3LZ A2633|MPUF3BE A2882|MQ913LL A2651|MQ9P3BE A2894|MHDC3LZ A2221|MQ9T3BE A2894|MQ9W3BE A2894|MQ0G3BE A2890|MQ183BE A2890|MQ1F3BE A2890|MLQ83LZ A2633/g, '');  //Iphone
    ...
    novoNome = novoNome.replace("IPHONE 8 +", 'IPHONE 8 PLUS');  
